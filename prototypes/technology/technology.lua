...
-- for _, tech in pairs(techs_to_show) do
--     local is_science = string.find(tech, "science")
--     if not (is_science==nil) and data.raw["technology"][tech] then
--         data.raw["technology"][tech].hidden = false
--     end
-- end